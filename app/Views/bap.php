        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" style="max-height: 900px;">
                    <img class="w-100" src="img/content-8.jpg" alt="Image">
            ...
            <div class="row align-items-center gx-5">
                ...
                <div class="col-lg-6 align-middle wow slideInRight" data-wow-delay="0.6s">
                    <div class="py-5">
                        ...
                        <p class="text-black mb-3">A Simple Way To Plan Your Project</p>
                        ...
                        <p class="text-black"><i class="fa fa-dot-circle text-success me-3 "></i>Complete timesheet submission and approval record</p>
                        <p class="text-black"><i class="fa fa-dot-circle text-success me-3 "></i>On-demand timesheet summary report</p>
                        <p class="text-black"><i class="fa fa-dot-circle text-success me-3 "></i>Paperless and user-friendly app</p>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="col d-flex justify-content-center">
                        <h2 class="text-white mb-2" data-toggle="counter-up">1897</h2>
                        <h2 class="text-white mb-2">+</h2>
                    </div>
                ...
                <div class="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.7s">
                    ...
                    <div class="col d-flex justify-content-center">
                        <h2 class="text-white mb-2" data-toggle="counter-up">2879</h2>
                        <h2 class="text-white mb-2">+</h2>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid text-center" src="/img/Complete Equipment/BULLDOZER CAT 15T D6GC.jpeg" style="padding-bottom: 50px;" alt="" >
                            <div class="team-overlay position-absolute start-0 top-0 mt-3 w-100 h-100">
                                <!-- <small class="text-light text-center">Detail :<br> ipsum dolor sit amet consectetur adipisicing elit. Unde optio architecto id veniam vitae asperiores voluptatibus minus at nulla ipsum?</small> -->
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden" style="padding-bottom: 50px;">
                            <img class="img-fluid" src="img/Complete Equipment/MOTOR GRADER CAT 3M 120.jpeg" alt="">
