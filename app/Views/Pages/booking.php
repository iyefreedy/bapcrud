        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        <h1 class="text-white mb-4">Certified Equipment Rent Provider</h1>
                ...
                <div class="col-lg-6">
                    <div class="bg-secondary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        <h1 class="text-white mb-4">Book For A Rent</h1>
                        <form>
                            <div class="row g-3">
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-8 col-md-6">
                    ...
                    <h1 class="mb-4">Have Any Pre Rental Question?</h1>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="bg-secondary d-flex flex-column justify-content-center text-center h-100 p-4">
                        <h3 class="text-white mb-4"><i class="fa fa-phone-alt me-3"></i>+62 345 6789</h3>
